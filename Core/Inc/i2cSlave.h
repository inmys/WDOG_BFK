...
#define I2C_BOOTPIN SysCntrl.stmbootsel<<2
#define I2C_WDOG SysCntrl.Watchdog<<3
#define I2C_INTEN SysCntrl.intEn<<4
#define I2C_DORESET (SysCntrl.PowerState==41)<<5
#define I2C_DOPWROFF (SysCntrl.PowerState==11)<<6

#define I2C_RREG0 I2C_DOPWROFF|I2C_DORESET|I2C_INTEN|I2C_WDOG|I2C_BOOTPIN|I2C_RSTBTN|I2C_PWRBTN
